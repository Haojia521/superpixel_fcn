...
parser.add_argument('--milestones', type=int, default=[200000], metavar='N', nargs='*', help='epochs at which learning rate is divided by 2')
parser.add_argument('--additional_step', type=int, default= 100000, help='the additional iteration, after lr decay')
